...
export const CURRENCIES: CurrencyDefinition[] = [
  {
    ...
    major: {
      gender: 'masculine',
      ar: { singular: 'دينار عراقي', dual: 'ديناران عراقيان', plural: 'دنانير عراقية', accusative: 'دينارا عراقيا' },
      enSingular: 'Iraqi Dinar',
      enPlural: 'Iraqi Dinars',
    },
    minor: {
      gender: 'masculine',
      ar: { singular: 'فلس', dual: 'فلسان', plural: 'فلوس', accusative: 'فلسا' },
      enSingular: 'Fils',
      enPlural: 'Fils',
    },
  },
  {
    ...
    major: {
      gender: 'masculine',
      ar: { singular: 'دولار أمريكي', dual: 'دولاران أمريكيان', plural: 'دولارات أمريكية', accusative: 'دولارا أمريكيا' },
      enSingular: 'US Dollar',
      enPlural: 'US Dollars',
    },
    minor: {
      gender: 'masculine',
      ar: { singular: 'سنت', dual: 'سنتان', plural: 'سنتات', accusative: 'سنتا' },
      enSingular: 'Cent',
      enPlural: 'Cents',
    },
  },
  ...
  },
  {
    ...
    minor: {
      gender: 'masculine',
      ar: { singular: 'بنس', dual: 'بنسان', plural: 'بنسات', accusative: 'بنسا' },
      enSingular: 'Penny',
      enPlural: 'Pence',
    },
  },
  {
    ...
    major: {
      gender: 'masculine',
      ar: { singular: 'ريال سعودي', dual: 'ريالان سعوديان', plural: 'ريالات سعودية', accusative: 'ريالا سعوديا' },
      enSingular: 'Saudi Riyal',
      enPlural: 'Saudi Riyals',
    },
    minor: {
      gender: 'feminine',
      ar: { singular: 'هللة', dual: 'هللتان', plural: 'هللات', accusative: 'هللة' },
      enSingular: 'Halala',
      enPlural: 'Halalas',
    },
  },
  ...
  },
  {
    ...
    major: {
      gender: 'masculine',
      ar: { singular: 'دينار كويتي', dual: 'ديناران كويتيان', plural: 'دنانير كويتية', accusative: 'دينارا كويتيا' },
  ...
  },
  {
    ...
    major: {
      gender: 'masculine',
      ar: { singular: 'دينار أردني', dual: 'ديناران أردنيان', plural: 'دنانير أردنية', accusative: 'دينارا أردنيا' },
  ...
  },
  {
    ...
    major: {
      gender: 'feminine',
      ar: { singular: 'ليرة تركية', dual: 'ليرتان تركيتان', plural: 'ليرات تركية', accusative: 'ليرة تركية' },
      enSingular: 'Turkish Lira',
      enPlural: 'Turkish Liras',
    },
    minor: {
      gender: 'masculine',
      ar: { singular: 'قرش', dual: 'قرشان', plural: 'قروش', accusative: 'قرشا' },
      enSingular: 'Kurus',
      enPlural: 'Kurus',
    },
  },
